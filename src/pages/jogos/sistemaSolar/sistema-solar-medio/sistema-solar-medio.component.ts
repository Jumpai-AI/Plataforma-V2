...
@Component({
  selector: 'app-sistema-solar-medio',
  standalone: true,
  imports: [CeuEstreladoComponent],
  templateUrl: './sistema-solar-medio.component.html',
  styleUrl: './sistema-solar-medio.component.scss'
})
export class SistemaSolarMedioComponent {
  ...
  imagemMeteoro: string = "../../../../assets/image/jogos/sistema-solar/meteoro.png";
  ...
  ngAfterViewInit(): void {
    if (isPlatformBrowser(this.platformId)) {
      ...
      setInterval(() => this.criarMeteoro(), 10000);
    }
  }
  ...
  moverPlaneta(planeta: HTMLElement): void {
    let intervaloPlaneta = setInterval(() => {
      ...
      if (planetaRight >= window.innerWidth) {
        ...
        planeta.style.right = planetaRight + 6 + 'px'; //velocidade
      }
      if (
  ...
  moverMeteoro(meteoro: HTMLElement): void {
    let intervaloMeteoro = setInterval(() => {
      ...
      if (meteoroRight >= window.innerWidth) {
        ...
        meteoro.style.right = meteoroRight + 5 + 'px'; //velocidade do meteoro
      }
      if (
